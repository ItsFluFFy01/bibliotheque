        ...
        <div className={`${darkMode ? 'bg-gray-800 card-shadow-dark' : 'bg-white card-shadow'} rounded-lg p-6 w-full max-w-6xl`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className={`border ${darkMode ? 'border-gray-700' : 'border-gray-200'} rounded-lg p-6 text-center`}>
              <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Gestion des utilisateurs</h2>
              <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} mb-4 font-medium`}>Ajoutez, modifiez et visualisez les utilisateurs</p>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} text-sm leading-relaxed`}>
                Gérez facilement les comptes utilisateurs avec des fonctionnalités complètes pour ajouter de nouveaux membres, modifier les informations existantes et suivre les activités.
              </p>
              <Link to="/users">
                <button className={`mt-6 ${darkMode ? 'main-button-dark' : 'main-button'}`}>Voir les utilisateurs</button>
              </Link>
            </div>
           ...
           <div className={`border ${darkMode ? 'border-gray-700' : 'border-gray-200'} rounded-lg p-6 text-center`}>
                         ...
                         <Link to="/bibliotheque">
                           <button className={`mt-6 ${darkMode ? 'main-button-dark' : 'main-button'}`}>Voir la bibliothèque</button>
                         </Link>
                       </div>
          </div>
          {/* Quick Actions */}
